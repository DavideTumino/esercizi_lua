...
--[[ 
	dobbiamo fare i controlli con gli IP, per capire se un SYN è in ingresso o in uscita, poi dobbiamo salvare gli IP perchè
	distanza di tempo magari parlo di nuovo con un IP, e in fine dobbiamo capire lo spacchio di UDP
]]--
